...
$(function () {
    ...
    $("#zhis").html('请'+zhi.substr(2,zhi.length));
    ...
    $("#add").click(function () {
        tuanBut(getParams("orderId"),getParams("salesmanId"));
    });
    //业务上传出款凭证
    function tuanBut(orderId,salesmanId) {

        layer.confirm(zhi,function(){
            ...
            fromData.append("operatedId",salesmanId);
            fromData.append("imgType",imageType);
            jQuery.ajax({
                url: "/upFiles",
                dataType: "json",
                type: "post",
