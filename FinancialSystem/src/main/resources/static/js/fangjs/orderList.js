...
function renderPageData02(infoEntrylist){
    //移除之前的数据
  ...
  for(var i=0;i<infoEntrylist.length;i++){
    ...
    //交易类型
      ...
      //费用支付方式
     var payMent = infoEntrylist[i].feeWay == 0 ? "费用前置" : "费用后置"

      console.log(infoEntrylist[i]);
      $('tbody').append("<tr>"+
          "                            <td>"+infoEntrylist[i].orderId+"</td>"+
          "                            <td>"+infoEntrylist[i].userName+"</td>"+
          "                            <td>"+infoEntrylist[i].phone+"</td>"+
          "                            <td>"+infoEntrylist[i].amount+"</td>"+
          "                            <td>"+infoEntrylist[i].amountDays+"天</td>"+
          "                            <td>"+status+"</td>"+
          "                            <td>"+payType+"</td>"+
          "                            <td>"+payMent+"</td>"+
          "                            <td>"+infoEntrylist[i].address+"</td>"+
          "                            <td>"+infoEntrylist[i].createDate+"</td>"+
          "                            <td class='td-manage'>"+
          "                                <a class='layui-btn layui-btn-xs' lay-event='edit' id='show'"+
          "                                   style='text-align: center' href='order-edit.html?orderId="+infoEntrylist[i].orderId+"'>编辑</a>"+
          "                                <a class='layui-btn layui-btn-danger layui-btn-xs' lay-event='del'"+
          "                                   onclick='member_del(this,infoEntrylist[i].orderId)' style='text-align: center'>删除</a>"+
          "                            </td>"+
          "                        </tr>");
  }
}
